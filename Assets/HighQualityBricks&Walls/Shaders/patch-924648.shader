...
Shader "High Quality Bricks & Walls/patch-924648" {
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _node_5554; uniform float4 _node_5554_ST;
            struct VertexInput {
...
////// Specular:
                ...
                float4 _node_5554_var = tex2D(_node_5554,TRANSFORM_TEX(i.uv0, _node_5554));
                ...
                float3 indirectSpecular = (gi.indirect.specular + _node_5554_var.rgb);
