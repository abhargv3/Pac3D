...
Shader "High Quality Bricks & Walls/tile-846018" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _node_6708; uniform float4 _node_6708_ST;
            struct VertexInput {
...
////// Specular:
                ...
                float4 _node_6708_var = tex2D(_node_6708,TRANSFORM_TEX(i.uv0, _node_6708));
                ...
                float3 indirectSpecular = (gi.indirect.specular + _node_6708_var.rgb);
