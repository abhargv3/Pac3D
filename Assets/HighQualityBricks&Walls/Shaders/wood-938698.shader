...
Shader "High Quality Bricks & Walls/wood-938698" {
    Properties {
        _BumpMap ("Normal Map", 2D) = "bump" {}
        _Color ("Color", Color) = (0.7573529,0.7573529,0.7573529,1)
        _MainTex ("Base Color", 2D) = "white" {}
        _Metallic ("Metallic", Range(0, 1)) = 0.2136752
        _Gloss ("Gloss", Range(0, 1)) = 0.3042735
        _node_9780 ("node_9780", 2D) = "white" {}
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
...
////// Specular:
                ...
                float4 _node_9780_var = tex2D(_node_9780,TRANSFORM_TEX(i.uv0, _node_9780));
                ...
                float3 indirectSpecular = (gi.indirect.specular + _node_9780_var.rgb);
